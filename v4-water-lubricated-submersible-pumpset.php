...
<section class="product-details-title-container">
  <div class="container-fluid big-pad">
    <div class="sec-title-wrapper">
      <h2 class="sec-title animation__char_come">  V4 Water Lubricated</h2>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 product-content-right-items">
          <div class="row">
              ...
              <div id="carousel-custom" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-outer">
                  <div class="carousel-inner image-box">
                    <?php
                      $data = glob("assets/imgs/inner-pages/products/detail-page/domestic-submersible-pumps/submersible-pumpsets/v4-water-lubricated/*.*");
                    ?> 
                    <?php 
                        $i = 0;
                        $active = "";
            ...
            <div class="col-lg-6">
              <div class="sec-title-wrapper">
                <h2 class="sec-title animation__char_come">V4 Water Lubricated Submersible Pumpset</h2>
                ...
                <ul class="product-list-check-icon">
                  ...
                  <li>All Ci components with CED coating.</li>
                </ul>
              ...
              <div class="tabs-content">
                  ...
                  <div class="reviews-box">
                    <div class="product-discription-ites">
                      <ul class="product-list-check-icon-item">
                        ...
                        <li>Trust Bearing — Stainless steel 420 Tilting pad segment with Carbon plate</li>
                ...
                <div class="tab" id="tab-2">
                  <div class="product-discription-ites">
                    <ul class="product-list-check-icon-item">
                      ...
                      <li>Bowl/Impeller — Noryl—Glass filed with stainless steel neck ring</li>
                ...
                <div class="tab" id="tab-4">
                  <div class="product-discription-ites">
                    <ul class="product-list-check-icon-item">
                      <li>4" (100 MM)</li>
                      <li>1 PHASE : (180-240V)</li>
                      <li>3 PHASE : (300-415V)</li>
                      <li>HP : 0.5 HP TO 7.5 HP (1Ø / 3Ø)</li>
                      <li>HEAD : 7 MTR T0 420 MTR</li>
                      <li>CAPACITY : 12 LPM TO 425 LPM</li>
                      <li>AC,50Hz, 2800 RPM</li>
                      <li>TOTAL NO. OF MODELS : 168 Nos.(1Ø / 3Ø)</li>
                      <li>ISI MODELS : 40 NOS.(1Ø/3Ø)</li>
                    </ul>
                  </div>
                </div>
              </div>
