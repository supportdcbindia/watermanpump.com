...
<section class="product-details-title-container">
  <div class="container-fluid big-pad">
    <div class="sec-title-wrapper">
      <h2 class="sec-title animation__char_come">V5 Water Lubricated Pumpset</h2>
    </div>
    <div class="breadcrumb animation__char_come">
      <ul>
        ...
        <li>V5 Water Lubricated Pumpset</li>
      </ul>
    </div>
  </div>
</section>
              ...
              <div id="carousel-custom" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-outer">
                  <div class="carousel-inner image-box">
                    <?php
                      $data = glob("assets/imgs/inner-pages/products/detail-page/domestic-submersible-pumps/submersible-pumpsets/v5-water-lubricated-pumpset/*.*");
                    ?> 
                    <?php 
                        $i = 0;
                        $active = "";
