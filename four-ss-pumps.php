              ...
              <div id="carousel-custom" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-outer">
                  <div class="carousel-inner image-box">
                    <?php
                      $data = glob("assets/imgs/inner-pages/products/detail-page/export-submersible-motor-pumps/export-submersible-pumps/4-ss-pumps/*.*");
                    ?> 
                    <?php 
                        $i = 0;
                        $active = "";
            ...
            <div class="col-lg-6">
              <div class="sec-title-wrapper">
				...
				<ul class="product-list-check-icon-item">
					...
					<li>Size for connection to the motor according to NEMA standards</li>
					...
					<li>Impeller:
						<ul>
							<li>Radial Flow impellers</li>
							<li>WSP2, WSP3, WSP5</li>
              ...
              <div class="tabs-content">
				...
				<div class="tab" id="tab-2">
                  <div class="reviews-box">
                    <div class="product-discription-ites">
                      <ul class="product-list-check-icon-item">
                        <li>Flow range: Max. 18 .8 m</li>
                        <li>Head range: Max. 547m</li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="reviews-box">
                    <div class="product-discription-ites">
                      <ul class="product-list-check-icon-item">
                        ...
                        <li>Max. sand content into the water:50 g/m</li>
                        <li>Max. starts per hour : 30 at regular intervals</li>
				...
				<div class="tab" id="tab-4">
                  <div class="reviews-box">
                    <div class="product-discription-ites">
                      <ul class="product-list-check-icon-item">
                        <li>Also available in stainless steel AISI 316 material (for sea water application).</li>
