...
<section class="product-details-title-container">
  <div class="container-fluid big-pad">
    <div class="sec-title-wrapper">
      <h2 class="sec-title animation__char_come">8'' SS pumps</h2>
    </div>
              ...
              <div id="carousel-custom" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-outer">
                  <div class="carousel-inner image-box">
                    <?php
                      $data = glob("assets/imgs/inner-pages/products/detail-page/export-submersible-motor-pumps/export-submersible-pumps/8-ss-pumps/*.*");
                    ?> 
                    <?php 
                        $i = 0;
                        $active = "";
            ...
            <div class="col-lg-6">
              <div class="sec-title-wrapper">
				...
				<ul class="product-list-check-icon-item">
					<li>Submersible motor &amp; pumps for deep wells of 8” (DN 100 mm).</li>
              ...
              <div class="tabs-content">
				...
				<div class="tab" id="tab-2">
                  <div class="reviews-box">
                    <div class="product-discription-ites">
                      <ul class="product-list-check-icon-item">
                        <li>Flow range: Max. 123.8m<sup>3</sup>/h</li>
                        <li>Head range: Max. 423m</li>
                      </ul>
                    </div>
                  </div>
                </div>
