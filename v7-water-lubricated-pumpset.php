...
<section class="product-details-title-container">
  <div class="container-fluid big-pad">
    <div class="sec-title-wrapper">
      <h2 class="sec-title animation__char_come">V7 Water Lubricated Pumpset</h2>
    </div>
              ...
              <div id="carousel-custom" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-outer">
                  <div class="carousel-inner image-box">
                    <?php
                      $data = glob("assets/imgs/inner-pages/products/detail-page/domestic-submersible-pumps/submersible-pumpsets/v7-water-lubricated-pumpsets/*.*");
                    ?> 
                    <?php 
                        $i = 0;
                        $active = "";
            ...
            <div class="tabs-box">
              ...
              <div class="tabs-content">
                ...
                <div class="tab" id="tab-2">
                  <div class="product-discription-ites">
                    <ul class="product-list-check-icon-item">
                      ...
                      <li>Neckring - Nitrile Rubber for sand application</li>
                ...
                <div class="tab" id="tab-4">
                  <div class="product-discription-ites">
                    <ul class="product-list-check-icon-item">
                      <li>4.0 HP TO 30 HP</li>
                      <li>THREE PHASE: 300-415V</li>
                      <li>HEAD: 9 MTR TO 88 MTR</li>
                      <li>CAPACITY: 510 LPM TO 2130 LPM</li>
                      <li>TOTAL NO. OF MODELS: 61 Nos.</li>
                      <li>ISI MODELS: 9 Nos.</li>
                    </ul>
                  </div>
                </div>
              </div>
