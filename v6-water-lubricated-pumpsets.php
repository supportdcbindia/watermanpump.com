...
<section class="product-details-title-container">
  <div class="container-fluid big-pad">
    <div class="sec-title-wrapper">
      <h2 class="sec-title animation__char_come">V6 Water Lubricated Pumpsets</h2>
    </div>
    <div class="breadcrumb animation__char_come">
      <ul>
        ...
        <li>V6 Water Lubricated Pumpsets</li>
      </ul>
    </div>
  </div>
</section>
              ...
              <div id="carousel-custom" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-outer">
                  <div class="carousel-inner image-box">
                    <?php
                      $data = glob("assets/imgs/inner-pages/products/detail-page/domestic-submersible-pumps/submersible-pumpsets/v6-water-lubricated-pumpsets/*.*");
                    ?> 
                    <?php 
                        $i = 0;
                        $active = "";
            ...
            <div class="tabs-box">
              ...
              <div class="tabs-content">
                  ...
                  <div class="reviews-box">
                    <div class="product-discription-ites">
                      <ul class="product-list-check-icon-item">
                        ...
                        <li>Stainless Steel - 420 Tilting pad segment with carbon plate</li>
                ...
                <div class="tab" id="tab-4">
                  <div class="product-discription-ites">
                    <ul class="product-list-check-icon-item">
                      <li>3.0 HP TO 30 HP</li>
                      <li>SINGLE PHASE : 180 - 240V</li>
                      <li>THREE PHASE : 300 - 415V</li>
                      <li>HEAD : 9 MTR TO 360 MTR</li>
                      <li>CAPACITY : 45 LPM TO 1170 LPM</li>
                      <li>AC, 50 HZ, 2900 RPM</li>
                      <li>TOTAL NO. OF MODELS : MORE THAN 550 Nos.</li>
                      <li>ISI MODELS : 460 Nos.</li>
                    </ul>
                  </div>
                </div>
              </div>
